...
blog_render <- function (fname, centre_images = TRUE) {
    ...
    md <- readLines (paste0 (fname, ".html"))
    ...
    # Convert markdown tables to HTML tables with CSS styling to prevent Panini's
    # markdown processor from adding deprecated align attributes
    md <- convert_markdown_tables_to_html(md)
    ...
    writeLines (md, paste0 (fname, ".html"))
