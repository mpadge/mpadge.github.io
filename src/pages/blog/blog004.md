...
“recursively to the installation directory” (from Writing R Extensions).
...
accessible through the `system.file()` function, and leaving the C code
able to simply call the macro `MY_DICTIONARY` to access the local copy
of that file.
